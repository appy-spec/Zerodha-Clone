    ...
    <div className="container mt-3" style={{marginLeft:"9%"}}>
      ...
      <div className="row">
        <div className="col-4 mb-3">
          <h3 className="fs-5" style={{fontWeight:"390"}}><i class="fa-regular fa-circle-dot"></i> Account Opening</h3>
        ...
        <div className="col-4 mb-3">
          <h3 className="fs-5" style={{fontWeight:"390"}}><i class="fa-solid fa-circle-user"></i> Your Zerodha Account</h3>
        ...
        <div className="col-4 mb-3">
          <h3 className="fs-5" style={{fontWeight:"390"}}><i class="fa-regular fa-chart-bar"></i> Kite</h3>
      ...
      <div className="row mt-4">
        <div className="col-4 mb-3">
          <h3 className="fs-5" style={{fontWeight:"390"}}><i class="fa-regular fa-credit-card"></i> Funds</h3>
        ...
        <div className="col-4 mb-3">
          <h3 className="fs-5" style={{fontWeight:"390"}}><i class="fa-regular fa-message"></i> Console</h3>
        ...
        <div className="col-4 mb-3">
          <h3 className="fs-5" style={{fontWeight:"390"}}><i class="fa-regular fa-circle"></i> Coin</h3>
